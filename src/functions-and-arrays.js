...
function avg(mixedArray) {
  ...
  //below code was returning 5.111111111111111 but was testing for 5.11 so I rounded it to 2 decimal points   
  const total = sum(mixedArray) / mixedArray.length;
...
/// sorry I ran out of time to try this one! :( I would love to know the answer though
